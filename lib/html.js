...
Html = {
	...
	"toString": function( value ) {
		if ( value instanceof HtmlString ) {
			...
			// it is possible for an object to not be an "HtmlString" but still return an HtmlString when its toString
			// method is called.
			var str = typeof value.toString === "function" ? value.toString() : value+"";
			return str instanceof HtmlString ? str.toString() : Html.Encode( value+""  );
		}
	}
